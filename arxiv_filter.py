...
parser = argparse.ArgumentParser(description="Filter arXiv daily emails based on keywords and authors.")
parser.add_argument('-k', '--keyword', nargs='+', help='A list of keywords to search for in title and abstract.')
